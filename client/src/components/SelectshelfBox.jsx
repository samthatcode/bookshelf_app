...
import { Button, Modal, Box, FormControl, Select, MenuItem } from '@chakra-ui/react';
  ...
  return (
    <div>
      <Modal open={modal.open} >
        <div style={{ width: "300px" }} >Choose a bookshelf: </div>
        {(modal.type == "Clear") ? <Box>Be careful, this operation will sync to your Google book account, and it cannot be undone.</Box> : <></>}
        <Box>
